...
class FullscreenPlayer extends StatefulWidget {
  ...
  _FullscreenPlayerState createState() =>
      _FullscreenPlayerState(id, autoPlay!, looping!, controller!, position!, initFuture!, qualityValue!);
}
...
class _FullscreenPlayerState extends State<FullscreenPlayer> {
  ...
  _FullscreenPlayerState(
      this._id, this.autoPlay, this.looping, this.controller, this.position, this.initFuture, this.qualityValue);
