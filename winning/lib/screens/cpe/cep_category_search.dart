...
class CepCategorySearch extends StatefulWidget {
  @override
  _CepCategorySearchState createState() => _CepCategorySearchState();
}

class _CepCategorySearchState extends State<CepCategorySearch> {
