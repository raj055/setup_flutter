...
class InspirationCategorySearch extends StatefulWidget {
  @override
  _InspirationCategorySearchState createState() => _InspirationCategorySearchState();
}

class _InspirationCategorySearchState extends State<InspirationCategorySearch> {
                ...
                onChanged: (text) {
                  if (text.isNotEmpty) {
                    ...
                    Api.httpWithoutLoader.post(
                      'inspiration-club-search',
                      data: {"inspiration_club_search": _searchController.text},
                    ).then(
                      (response) {
