...
class DocumentVideoSearch extends StatefulWidget {
  @override
  _DocumentVideoSearchState createState() => _DocumentVideoSearchState();
}

class _DocumentVideoSearchState extends State<DocumentVideoSearch> {
          ...
          child: Column(
            children: <Widget>[
              TextField(
                ...
                onChanged: (text) {
                  if (videoDataSearch!['pageType'] == 'inspiration') {
                    if (text.isNotEmpty) {
                      showLoader = false;
                      Map sendData = {
                        "title": _searchController.text,
                        "inspiration_id": videoDataSearch!['id'],
                        "type": videoDataSearch!['typeId'],
                      };
                  ...
                  } else if (videoDataSearch!['pageType'] == 'vestige') {
                    if (text.isNotEmpty) {
                      showLoader = false;
                      Map sendData = {
                        "title": _searchController.text,
                        "vestige_id": videoDataSearch!['id'],
                        "type": videoDataSearch!['typeId'],
                      };
                      Api.httpWithoutLoader
                          .post(
                  ...
                  } else if (videoDataSearch!['pageType'] == 'cep') {
                    if (text.isNotEmpty) {
                      showLoader = false;
                      Map sendData = {
                        "title": _searchController.text,
                        "cep_id": videoDataSearch!['id'],
                        "type": videoDataSearch!['typeId'],
                      };
                      Api.httpWithoutLoader
                          .post(
                  ...
                  } else if (videoDataSearch!['pageType'] == 'cep-prime') {
                    if (text.isNotEmpty) {
                      showLoader = false;
                      Map sendData = {
                        "title": _searchController.text,
                        "cep_prime_id": videoDataSearch!['id'],
                        "type": videoDataSearch!['typeId'],
                      };
                      Api.httpWithoutLoader
                          .post(
