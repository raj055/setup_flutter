...
class DocumentEbookSearch extends StatefulWidget {
  @override
  _DocumentEbookSearchState createState() => _DocumentEbookSearchState();
}

class _DocumentEbookSearchState extends State<DocumentEbookSearch> {
          ...
          child: Column(
            children: <Widget>[
              TextField(
                ...
                onChanged: (text) {
                  if (ebookDataSearch!['pageType'] == 'inspiration') {
                    if (text.isNotEmpty) {
                      showLoader = false;
                      Map sendData = {
                        "title": _searchController.text,
                        "inspiration_id": ebookDataSearch!['id'],
                        "type": ebookDataSearch!['typeId'],
                      };
                  ...
                  } else if (ebookDataSearch!['pageType'] == 'vestige') {
                    if (text.isNotEmpty) {
                      showLoader = false;
                      Map sendData = {
                        "title": _searchController.text,
                        "vestige_id": ebookDataSearch!['id'],
                        "type": ebookDataSearch!['typeId'],
                      };
                  ...
                  } else if (ebookDataSearch!['pageType'] == 'cep') {
                    if (text.isNotEmpty) {
                      showLoader = false;
                      Map sendData = {
                        "title": _searchController.text,
                        "cep_id": ebookDataSearch!['id'],
                        "type": ebookDataSearch!['typeId'],
                      };
                  ...
                  } else if (ebookDataSearch!['pageType'] == 'cep-prime') {
                    if (text.isNotEmpty) {
                      showLoader = false;
                      Map sendData = {
                        "title": _searchController.text,
                        "cep_prime_id": ebookDataSearch!['id'],
                        "type": ebookDataSearch!['typeId'],
                      };
              ...
              Expanded(
                child: ListView(
                  children: <Widget>[
                    if (searchedData != null && _searchController.text.isNotEmpty) buildDetails(context, searchedData!),
                    SizedBox(height: 10)
                  ],
                ),
              ),
