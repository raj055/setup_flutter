...
class CepPrimeCategorySearch extends StatefulWidget {
  @override
  _CepPrimeCategorySearchState createState() => _CepPrimeCategorySearchState();
}

class _CepPrimeCategorySearchState extends State<CepPrimeCategorySearch> {
                        ...
                        if (response.data['status']) {
                          if (mounted) {
                            setState(
                              () {
                                showLoader = true;
                                searchedData = response.data['list']['data'];
                                error = null;
                              },
                            );
                          }
