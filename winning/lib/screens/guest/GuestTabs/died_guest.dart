...
import '../../training/training_description.dart';

class DiedGuest extends StatefulWidget {
  @override
  _DiedGuestState createState() => _DiedGuestState();
}

class _DiedGuestState extends State<DiedGuest> {
  GlobalKey<PaginatedListState> diedGuestPaginatedListKey = GlobalKey();
  String selectTab = "6";
  var guestList;
  List? training;
      ...
      children: <Widget>[
        ...
        Expanded(
          child: PaginatedList(
            ...
            listItemBuilder: diedGuestBuilder,
  ...
  Widget diedGuestBuilder(diedGuest, index) => SizedBox(
        child: FadeAnimation(
          0.9,
          Container(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                Expanded(
                                  child: IconButton(
                                    onPressed: () {
                                      launchWhatsApp(diedGuest["mobile"], "");
                                    },
                                    icon: Icon(
                    ...
                    children: <Widget>[
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(
                              Translator.get('Days to Not Interested')!,
                              softWrap: true,
                              maxLines: 2,
                              style: TextStyle(
                                color: Colors.black54,
                      ...
                      child: Row(
                        children: <Widget>[
                          Padding(
                            ...
                            child: Text(Translator.get('Start Re-Follow Up')!),
                          )
                        ],
                      ),
                    ),
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: FlatButton(
                                ...
                                onPressed: () {
                                  Api.http.put(
                                    "re-follow-up-guest-label",
                                    data: {
                                      "re_follow_up": "1",
                                      "guest_id": diedGuest["userId"],
                                      "mobile": diedGuest["mobile"],
                                      "label_id": "6"
                                    },
                                  ).then(
                                    (res) {
                                      GetBar(
                                        backgroundColor: res.data['status']
                                            ? Colors.green
                                            : Colors.red,
                                        duration: Duration(seconds: 5),
                                        message: res.data['message'],
                                      ).show();
                                      diedGuestPaginatedListKey.currentState!
                                          .refresh();
                                    },
                                  ).catchError(
                                    (error) {
