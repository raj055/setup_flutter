...
class ValidatorX {
    ...
    return (String value, {String? key}) {
      if (value.length < length!) {
        return _getMessage(
          message: message!,
          defaultMessage:
              'The $key field should contain at-least $length characters.',
        );
      }
  ...
  static confirm(TextEditingController passwordTextController, String? showName,
      {String? message = ''}) {
    return (String value, {String? key}) {
