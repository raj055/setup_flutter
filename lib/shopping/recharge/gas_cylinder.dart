...
class GasCylinder extends StatefulWidget {
  @override
  _GasCylinderState createState() => _GasCylinderState();
}

class _GasCylinderState extends State<GasCylinder> {
        ...
        rules: [
          ValidatorX.custom((value, {key}) {
            ...
            if (value!.length == 0) {
              ...
              return "Customer mobile number must 10 digits";
            } else if (!regExp.hasMatch(value)) {
